...
result_path = "C:/Users/plexa/OneDrive/Bayreuth/LSS5-LSS20/diffPy/multiple_datasets/fit_results/variable_spacegroups/box_car/"

def run():
    #ranges = [(1.8, 8), (5, 15), (10, 20), (15, 25), (20, 30), (25, 35)]
    ranges = [(1.8, 10),(10, 18.2)]
    #t-subgroups
    t_subgroups = [
        "Pnma",
        "Pnmm",
    ...
    for name, path in datasets.items():
        ...
        for range in ranges:
            ...
            for sg in space_groups:
                recipe = make_recipe(LSS_cif, path, config=range_config, space_group=sg)  # Call the function to create the fit recipe
                ...
                result_path_dir = result_path + f"{name}_{sg}/" + f"fit_{range[0]}_{range[1]}/"
